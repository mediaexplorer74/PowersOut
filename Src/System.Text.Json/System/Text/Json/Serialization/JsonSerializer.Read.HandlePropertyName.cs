    ...
    public static partial class JsonSerializer
    {
            ...
            ref ReadStack state)
        {
            ...
            if (extensionData == null)
            {
                ...
                Debug.Assert(jsonPropertyInfo.DeclaredPropertyType.GetTypeInfo().IsGenericType);
                Debug.Assert(jsonPropertyInfo.DeclaredPropertyType.GetTypeInfo().GenericTypeArguments.Length == 2);
                //Debug.Assert(jsonPropertyInfo.DeclaredPropertyType.GetTypeInfo().GenericTypeArguments[0].UnderlyingSystemType == typeof(string));
                //Debug.Assert(
                //    jsonPropertyInfo.DeclaredPropertyType.GetTypeInfo().GenericTypeArguments[1].UnderlyingSystemType == typeof(object) ||
                //    jsonPropertyInfo.DeclaredPropertyType.GetTypeInfo().GenericTypeArguments[1].UnderlyingSystemType == typeof(JsonElement));
