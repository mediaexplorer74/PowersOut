...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        /// </exception>
        public static /*Value*/Task<TValue> DeserializeAsync<TValue>(
            Stream utf8Json,
        ...
        /// or when there is remaining data in the Stream.
        /// </exception>
        public static /*Value*/Task<object> DeserializeAsync(
            Stream utf8Json,
            Type returnType,
            JsonSerializerOptions options = null,
            CancellationToken cancellationToken = default)
        ...
        private static async /*Value*/Task<TValue> ReadAsync<TValue>(
            Stream utf8Json,
            Type returnType,
            JsonSerializerOptions options = null,
            CancellationToken cancellationToken = default)
