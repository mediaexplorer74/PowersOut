...
namespace System.Text.Json
{
    internal static partial class ThrowHelper
    {
        ...
        public static void ThrowInvalidOperationOrArgumentException(ReadOnlySpan<byte> propertyName, 
            int currentDepth)
        {
            ...
            if (currentDepth >= JsonConstants.MaxWriterDepth)
            {
                ThrowInvalidOperationException(
                    "String.Format(SR.DepthTooLarge, currentDepth, JsonConstants.MaxWriterDepth)");
            }
            else
            {
        ...
        public static void ThrowInvalidOperationException(int currentDepth)
        {
            ...
            ThrowInvalidOperationException(String.Format("SR.DepthTooLarge", 
        ...
        public static void ThrowInvalidOperationOrArgumentException(ReadOnlySpan<char> propertyName, 
            int currentDepth)
        {
            currentDepth &= JsonConstants.RemoveFlagsBitMask;
            if (currentDepth >= JsonConstants.MaxWriterDepth)
        ...
        public static InvalidOperationException GetInvalidOperationException_ExpectedComment(
            ...
            JsonTokenType actualType)
        {
            return GetInvalidOperationException(
                String.Format("SR.JsonElementHasWrongType", 
        ...
        {
            return GetInvalidOperationException(
                String.Format("SR.JsonElementHasWrongType", expectedTypeName, actualType.ToValueKind()));
        }
        ...
        private static string GetResourceString(ref Utf8JsonReader json, ExceptionResource resource, byte nextByte, string characters)
        {
            ...
            switch (resource)
            {
                ...
                case ExceptionResource.UnexpectedEndOfLineSeparator:
                    ...
                    break;
                default:
                    Debug.Fail($"The ExceptionResource enum value: {resource} is not part of the switch. " +
                        $"Add the appropriate case and exception message.");
                    break;
            }
        ...
        // This function will convert an ExceptionResource enum value to the resource string.
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static string GetResourceString(ExceptionResource resource, int currentDepth, 
            byte token, JsonTokenType tokenType)
        {
            ...
            switch (resource)
            {
                ...
                case ExceptionResource.DepthTooLarge:
                    message = String.Format("SR.DepthTooLarge",
                        currentDepth & JsonConstants.RemoveFlagsBitMask, JsonConstants.MaxWriterDepth);
                    break;
        ...
        public static FormatException GetFormatException(NumericType numericType)
        {
            ...
            switch (numericType)
            {
                case NumericType.Byte:
                    message = "String.FormatByte";
                    break;
                case NumericType.SByte:
                    message = "String.FormatSByte";
                    break;
                case NumericType.Int16:
                    message = "String.FormatInt16";
                    break;
                case NumericType.Int32:
                    message = "String.FormatInt32";
                    break;
                case NumericType.Int64:
                    message = "String.FormatInt64";
                    break;
                case NumericType.UInt16:
                    message = "String.FormatUInt16";
                    break;
                case NumericType.UInt32:
                    message = "String.FormatUInt32";
                    break;
                case NumericType.UInt64:
                    message = "String.FormatUInt64";
                    break;
                case NumericType.Single:
                    message = "String.FormatSingle";
                    break;
                case NumericType.Double:
                    message = "String.FormatDouble";
                    break;
                case NumericType.Decimal:
                    message = "String.FormatDecimal";
                    break;
                default:
        ...
        public static FormatException GetFormatException(DataType dateType)
        {
            ...
            switch (dateType)
            {
                case DataType.DateTime:
                    message = "String.FormatDateTime";
                    break;
                case DataType.DateTimeOffset:
                    message = "String.FormatDateTimeOffset";
                    break;
                case DataType.Base64String:
                    message = "SR.CannotDecodeInvalidBase64";
                    break;
                case DataType.Guid:
                    message = "String.FormatGuid";
                    break;
                default:
