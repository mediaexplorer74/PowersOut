...
namespace System.Text.Json
{
    internal static partial class JsonWriterHelper
    {
        ...
        internal static void ValidateNumber(ReadOnlySpan<byte> utf8FormattedNumber)
        {
            ...
            if (utf8FormattedNumber[i] == '-')
            {
                ...
                if (utf8FormattedNumber.Length <= i)
                {
                    throw new ArgumentException(
                        "SR.RequiredDigitNotFoundEndOfData, nameof(utf8FormattedNumber)");
                }
            }
            ...
            {
                throw new ArgumentException(
                    "String.Format(SR.ExpectedEndOfDigitNotFound, ThrowHelper.GetPrintableString(val)),nameof(utf8FormattedNumber)");
            }
            ...
            {
                throw new ArgumentException(
                    /*SR.*/String.Format("SR.ExpectedEndOfDigitNotFound", ThrowHelper.GetPrintableString(utf8FormattedNumber[i])),
                    nameof(utf8FormattedNumber));
            }
        }
    }
