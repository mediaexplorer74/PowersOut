...
// Type: BlueJay.Component.System.Query`8
...
{
  internal class Query<A1, A2, A3, A4, A5, A6, A7, A8>(ILayers layers) : 
    Query(layers, KeyHelper.Create<A1, A2, A3, A4, A5, A6, A7, A8>()),
    IQuery<A1, A2, A3, A4, A5, A6, A7, A8>,
    IQuery,
    IEnumerable<IEntity>,
    IEnumerable
