...
// Type: BlueJay.Component.System.Query`6
...
{
  internal class Query<A1, A2, A3, A4, A5, A6>(ILayers layers) : 
    Query(layers, KeyHelper.Create<A1, A2, A3, A4, A5, A6>()),
    IQuery<A1, A2, A3, A4, A5, A6>,
    IQuery,
    IEnumerable<IEntity>,
    IEnumerable
