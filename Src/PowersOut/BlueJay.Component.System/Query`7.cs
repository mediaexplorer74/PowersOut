...
// Type: BlueJay.Component.System.Query`7
...
{
  internal class Query<A1, A2, A3, A4, A5, A6, A7>(ILayers layers) : 
    Query(layers, KeyHelper.Create<A1, A2, A3, A4, A5, A6, A7>()),
    IQuery<A1, A2, A3, A4, A5, A6, A7>,
    IQuery,
    IEnumerable<IEntity>,
    IEnumerable
